[Begin_ResourceLayout]
	...
	cbuffer PerFrame : register(b1)
	{
		...
		float Speed1		: packoffset(c0.y); [Default(0.2)]
		float Speed2		: packoffset(c0.z); [Default(0.3)]
		float3 WaterColor	: packoffset(c1);   [Default(0,0,1)]
		float Brightness	: packoffset(c1.w); [Default(1.0)]
		float3 WaterHightly : packoffset(c2);   [Default(0.5,0.8,1)]
		float Constract 	: packoffset(c2.w); [Default(1.5)]		
	}
