...
[Begin_Pass:Default]
	...
	static float SEA_HEIGHT = 0.6;
	static float SEA_CHOPPY = 4.0;
	static float SEA_SPEED = 0.8;
	static float SEA_FREQ = 0.16;
	static float3 SEA_BASE = float3(0.0,0.09,0.18);
	static float3 SEA_WATER_COLOR = float3(0.8,0.9,0.6)*0.6;
	...
	float3 getSeaColor(float3 p, float3 n, float3 l, float3 eye, float3 dist) {  
	    ...
	    float specularValue = specular(n,l,eye,60.0);
	    color += float3(specularValue.xxx);
	...
	{
		return float4(getPixel(input.Tex, Time/10),1);
	}
